"""The FAMILY-PARAMETERIZED SBC engine (S5-decisions item 11; moved into
the package in S6 WP3 so `mtk validate` can drive it -- tests/sbc_harness.py
re-exports every name from here, so the G3/G4 gates are untouched): "family +
